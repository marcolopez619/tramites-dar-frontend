...
export class HojaDeRutaComponent extends BaseComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    const idUnidadOrg = Number(
      idUnidadJef && idUnidadJef >= 0 ? idUnidadJef : idUnidadDir
    );

    this.parametricaService
      .getTipoDocumentos(idUnidadOrg)
      .pipe(takeUntil(this.unsubscribe$))
      .subscribe((listaTipoDocs) => {
    ...
    this.parametricaService
      ...
      .subscribe((listaTipoTramite) => {
        ...
        this.descripcionTramite = this.listaTipoTramite.filter(
          (x) => x.idTipoTramite === idTipoTramiteDefault
  ...
  onGuardarHojaDeRuta(): void {
    ...
    const datosFormulario: HojaDeRutaInsertModel = {};
    ...
    datosFormulario.ListDestCopia = null;
    datosFormulario.ListCite = null;
    datosFormulario.ListCiteExt = null;
    datosFormulario.ListAdjunto = null;
    ...
    this.hojaRutaService.insertHojaDeRuta(datosFormulario).pipe(takeUntil(this.unsubscribe$)).subscribe((result) => {
